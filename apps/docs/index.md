...
hero:
  ...
  tagline: Deposit USDC, earn the best available yield — automatically routed to whichever protocol is leading.
  actions:
    - theme: brand
      text: Get Started
...
features:
  ...
  - title: Non-custodial
    details: The server builds an unsigned transaction. You sign with Freighter. Private keys never leave your device.
